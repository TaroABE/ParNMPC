###########################################################################
## Makefile generated for component 'Simu_Matlab'. 
## 
## Makefile     : Simu_Matlab_rtw.mk
## Generated on : Fri Jun 09 12:25:42 2023
...
START_DIR                 = /home/abe-t/researches/programs/normal_ws/ParNMPC/RobotManipulator
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/Simu_Matlab -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
SRCS = $(START_DIR)/codegen/lib/Simu_Matlab/Simu_Matlab.cpp
...
%.o : $(START_DIR)/codegen/lib/Simu_Matlab/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/Simu_Matlab/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Simu_Matlab.o : $(START_DIR)/codegen/lib/Simu_Matlab/Simu_Matlab.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
